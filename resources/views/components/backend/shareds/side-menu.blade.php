<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        @can('lihat dasbor')
        <li class="nav-item">
            <a href="{{ route('backend.shortcodes.index') }}"
                class="nav-link {{ (Request::is('backend/shortcodes')) ? 'active' : '' }}">
        ...
        @endcan
        <li class="nav-item">
            <a href="{{ route('backend.templates.index') }}" class="nav-link {{ (Request::is('backend/templates')) ? 'active' : '' }}">
        ...
        <li class="nav-item">
            <a href="{{ route('backend.forms.index') }}" class="nav-link {{ (Request::is('backend/forms')) ? 'active' : '' }}">
                <i class="nav-icon fas fa-globe"></i>
                <p>
                    {{ __('Forms') }}
                </p>
